...
\begin{itemize}
	\item Any production is assumed to have a title.
	...
	\item A person can have several different roles within a production through a contract. These roles are defined as either an actor or not an actor (ex. writer or director).
